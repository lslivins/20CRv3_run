...
##SBATCH -t 00:46:00
#SBATCH -t 00:50:00
####SBATCH --time-min=00:36:00 SEG 27Aug24
...
####SBATCH -S 2
###SBATCH -L cscratch1
###SBATCH -L scratchi SEG comment out 29Aug24
...
# Load Intel environment SEG 27Aug24
...
#SEG 4Sep24
setenv maxcorespernode 120 #128 # 
...
#SEG 4Sep24
setenv fgmpitasks 120 #128  # 64 cores x 2 cpu per node
...
sbatch gfsenkf_20crV3_cmip5oz_new_knl_long_uc.csh  >&! current_jobid
