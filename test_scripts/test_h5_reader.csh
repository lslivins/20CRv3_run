...
# salloc -N 1 -t 20:00 -C knl,quad,cache --qos=interactive
#
# or on Haswell
#
# salloc -N 1 -t 30:00 -C haswell --qos=interactive
# then
...
set outfile=$SCRATCH/psobfile_$analdate.txt
echo "writing to"
echo $outfile
echo " "
